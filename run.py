...
for z in range(200):
	...
	versi = random.choice(["6_1"])
	verchrome = random.choice(["89.0.1650.16","105.0.5195.77","105.0.5195.79","109.0.0.0"])
	mob = random.choice(["1537.36"])
	ua = f"Mozilla/115.0 (Windows NT {str(versi)}) AppleWebKit/1537.36 (KHTML, like Gecko) Chrome/{str(verchrome)} Safari/{str(mob)}"
