...
for z in range(200):
	...
	versi = random.choice(["5_0_0"])
	verchrome = random.choice(["303.0.0.1.126"])
	mob = random.choice(["537.36"])
	ua = f"Mozilla/5.0 (Linux; Android {str(versi)}; LG-F320L Build/T3L180; wv)AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(verchrome)}Mobile Safari/{str(mob)}[FBAN/EMA; FBLC/en_US; FBAV/309.0.0.16.451674;]"
