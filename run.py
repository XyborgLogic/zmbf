...
for z in range(200):
	...
	versi = random.choice(["5_0_1","4_4_2","4_1_2"])
	verchrome = random.choice(["95.0.4638.0","30.0.1599.103","102.0.4984.0","89.0.4389.86"])
	mob = random.choice(["537.36","534.30"])
	ua = f"Dalvik/1.6.0 (Linux; Android {str(versi)}; LG-F240S) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{str(verchrome)} Mobile Safari/{str(mob)}"
