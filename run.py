...
for z in range(200):
	...
	versi = random.choice(["11"])
	verchrome = random.choice(["108.0.5359.128"])
	mob = random.choice(["537.36"])
	ua = f"Dalvik/2.1.0 (Linux; Android {str(versi)}; SHARK KLE-H0 Build/KLEN2208200OS00MR2; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(verchrome)} Mobile Safari/{str(mob)} [FB_IAB/FB4A;FBAV/396.0.0.21.104;]"
...
{color_text}│ {P2}Author : Fall Xavier(Simple Recode Xyborg) {color_text}│{color_text}│ {P2}Version : 2.0 {color_text}│{color_text}│ {P2}aku mau ua yang ijo bangett {color_text}│
