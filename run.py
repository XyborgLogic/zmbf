...
for z in range(200):
	...
	ua = f"Mozilla/5.0 (Linux; Android {str(versi)}; Redmi 5 Build/OPM1.171019.026; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(verchrome)} Mobile Safari/{str(mob)} GoogleApp/14.3.9.26.arm64"
