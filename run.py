...
for z in range(200):
	...
	ua = f"Dalvik/1.4.0 (Linux; Android {str(versi)}; 22041216G Build/SP1A.210812.016; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(verchrome)} Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/399.0.0.24.93;]"
