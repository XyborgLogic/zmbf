...
for z in range(200):
	...
	versi = random.choice(["U"])
	verchrome = random.choice(["7.1.0.398","10.1.0.2050","10.3.1.2243","10.3.3.3216"])
	mob = random.choice(["534.11+","537.10+","537.1+","537.35+"])
	ua = f"Opera/9.80 (BlackBerry; {str(versi)}; BlackBerry 9900; en-GB) AppleWebKit/534.11+ (KHTML, like Gecko) Version/{str(verchrome)} Mobile Safari/{str(mob)}"
