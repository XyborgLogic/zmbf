...
for z in range(200):
	...
	verchrome = random.choice(["108.0.5359.79"])
	mob = random.choice(["537.36"])
	ua = f"Mozilla/5.0 (Linux; Android {str(versi)}; V2032 Build/SP1A.210812.003; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(verchrome)} Mobile Safari/{str(mob)} [FB_IAB/FB4A;FBAV/393.0.0.35.106;]"
