...
for z in range(200):
	...
	verchrome = random.choice(["107.0.5304.141"])
	mob = random.choice(["537.36"])
	ua = f"Mozilla/5.0 (Linux; Android {str(versi)}; Pixel 7 Pro Build/TD1A.221105.001; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(verchrome)} Mobile Safari/{str(mob)} [FB_IAB/FB4A;FBAV/393.0.0.35.106;]"
