...
for z in range(200):
	...
	ua = f"Mozilla/5.0 (Linux; Android {}; LG-F320L Build/T3L180; wv)AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{} Mobile Safari/537.36[FBAN/EMA; FBLC/en_US; FBAV/309.0.0.16.451674;]"
