...
for z in range(200):
	...
	versi = random.choice(["8_1_0"])
	verchrome = random.choice(["87.0.4280.141","85.0.4183.120","88.0.4324.93","71.0.3578.83"])
	mob = random.choice(["537.36"])
	ua = f"Dalvik/2.1.0 (Linux; Android {str(versi)}; vivo Y83 Build/O11019; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(verchrome)} Mobile Safari/{str(mob)} [FB_IAB/FB4A;FBAV/193.0.0.45.101;]"
