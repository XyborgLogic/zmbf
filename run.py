...
for z in range(200):
	...
	versi = random.choice(["6_0"])
	verchrome = random.choice(["98.0.4758.101"])
	mob = random.choice(["537.36"])
	ua = f"Mozilla/5.0 (Linux; Android {str(versi)}; LG-H815 Build/MRA58K; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(verchrome)} Mobile Safari/{str(mob)} [FBAN/EMA;FBLC/pt_PT;FBAV/292.0.0.9.109;]"
