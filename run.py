...
for z in range(200):
	...
	versi = random.choice(["5_1_1","8_1_0"])
	verchrome = random.choice(["57.0.2987.132","95.0.4638.74","45.0.2454.95","86.0.4240.185"])
	mob = random.choice(["1537.36"])
	ua = f"Dalvik/2.1.0 (Linux; Android {str(versi)}; wt88047 Build/LMY47V; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(verchrome)} Mobile Safari/{str(mob)} [FB_IAB/FB4A;FBAV/330.0.0.31.120;]"
