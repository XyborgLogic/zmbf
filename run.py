...
for z in range(200):
	...
	verchrome = random.choice(["105.0.5195.136"])
	mob = random.choice(["537.36"])
	ua = f"Mozilla/5.0 (Linux; Android {str(versi)}; V2163A Build/RP1A.200720.012; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(verchrome)} Mobile Safari/{str(mob)} [FB_IAB/FB4A;FBAV/385.0.0.32.114;]"
