...
for z in range(200):
	...
	versi = random.choice(["7_1_2","8_1_0"])
	verchrome = random.choice(["73.0.3683.90","107.0.0.0","87.0.4280.86","69.0.3497.100"])
	mob = random.choice(["537.36"])
	ua = f"Dalvik/1.6.0 (Linux; Android {str(versi)}; Redmi 5 Build/N2G47H; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(verchrome)} Mobile Safari/{str(mob)} [FB_IAB/FB4A;FBAV/217.0.0.45.98;]"
