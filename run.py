...
for z in range(200):
	...
	versi = random.choice(["6_0_1","7_0_1","6_0_1","10","5_0_1"])
	verchrome = random.choice(["56.0.2924.87","69.0.3497.100","10.3.1.2243","55.0.2883.91"])
	mob = random.choice(["537.36"])
	ua = f"Dalvik/2.1.0 (Linux; Android {str(versi)}; SM-G532M Build/MMB29T; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(verchrome)} Mobile Safari/{str(mob)} [FB_IAB/FB4A;FBAV/239.0.0.41.152;]"
