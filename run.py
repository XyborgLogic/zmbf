...
for z in range(200):
	...
	versi = random.choice(["6"])
	verchrome = random.choice(["86.0.4240.198"])
	mob = random.choice(["537.36"])
	ua = f"Dalvik/2.1.0 (Linux; Android {str(versi)}; LG-H815 Build/MRA58K; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(verchrome)} Mobile Safari/{str(mob)} [FBAN/EMA;FBLC/it_IT;FBAV/225.0.0.12.114;]"
