...
for z in range(200):
	...
	versi = random.choice(["6_0_1","7_0_1","5_0_1"])
	verchrome = random.choice(["78.0.3904.108","69.0.3497.100","10.3.1.2243","55.0.2883.91"])
	mob = random.choice(["537.36"])
	ua = f"Mozilla/1.6.0 (Linux; Android {str(versi)}; Andromax A A16C3H) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{str(verchrome)} Mobile Safari/{str(mob)}"
