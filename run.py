...
for z in range(200):
	...
	ua = f"Dalvik/2.1.0 (Linux; Android {str(versi)}; H815 Build/MRA58K; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(verchrome)} Mobile Safari/{str(mob)}[FBAN/EMA;FBLC/it_IT;FBAV/225.0.0.12.114;]"
