...
for z in range(200):
	...
	versi = random.choice(["12"])
	verchrome = random.choice(["104.0.5112.110"])
	mob = random.choice(["537.36"])
	ua = f"Dalvik/2.1.0 (Linux; Android {str(versi)}; ASUS_I005DA Build/RKQ1..210821.001; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(verchrome)} Mobile Safari/{str(mob)} [FB_IAB/FB4A;FBAV/382.0.0.33.111;]"
