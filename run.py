...
for z in range(200):
	...
	versi = random.choice(["10"])
	verchrome = random.choice(["83.0.4103.106"])
	mob = random.choice(["537.36"])
	ua = f"Dalvik/2.1.0 (Linux; Android {str(versi)}; Lenovo 76S Build/MMB29M; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(verchrome)} Mobile Safari/{str(mob)} [FB_IAB/FB4A;FBAV/277.0.0.41.126;]"
