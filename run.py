...
for z in range(200):
	...
	verchrome = random.choice(["78.0.4702.100"])
	mob = random.choice(["537.36"])
	ua = f"Mozilla/5.0 (Linux; U; Android {str(versi)}; en-us; GT-V873U) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{str(verchrome)} Mobile Safari/{str(mob)}"
