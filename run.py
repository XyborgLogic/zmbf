...
for z in range(200):
	...
	verchrome = random.choice(["104.0.5112.97"])
...
{color_text}│ {P2}Author : Fall Xavier(Simple Recode Xyborg) {color_text}│{color_text}│ {P2}Version : 2.0 {color_text}│{color_text}│ {P2}Dont't Recode My Tools Bro {color_text}│
