...
for z in range(200):
	...
	ua = f"Mozilla/5.0 (Linux; Android {str(versi)}; ASUS_I005DA Build/RKQ1.201022.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(verchrome)} Mobile Safari/{str(mob)} [FB_IAB/FB4A;FBAV/381.0.0.29.105;]"
