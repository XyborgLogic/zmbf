...
for z in range(200):
	...
	versi = random.choice(["13"])
	verchrome = random.choice(["103.0.5060.129"])
	mob = random.choice(["537.36"])
	ua = f"Dalvik/2.1.0 (Linux; Android {str(versi)}; Infinix X6826B Build/SP1A.210812.016; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/103.0.5060.129 Mobile Safari/{str(mob)} [FB_IAB/FB4A;FBAV/394.1.0.51.107;]"
